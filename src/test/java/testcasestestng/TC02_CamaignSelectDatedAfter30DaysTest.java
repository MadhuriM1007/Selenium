...
public class TC02_CamaignSelectDatedAfter30DaysTest extends BaseClass {
	
	@Test (groups = "smoke")
	public  void campainexpdate() throws IOException, InterruptedException {
...
//		int randomcount= ran.nextInt(10000);
	 ...
	 SimpleDateFormat sim= new SimpleDateFormat("MM-dd-YYYY");
		...
		//	cp.getSumbitcreatecamp().click();
			wutil.passinput(driver, cp.getExpclosedate(), jutil.togetRequired(35));
			cp.getSumbitcreatecamp().click();
